...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contedos os valores esperados', () => {
    ...
    expect(Object.keys(circle(3))[1]).toBe('area'); // peguei a chave area
    expect(Object.keys(circle(3))[2]).toBe('circumference'); // peguei a chave circumference
    expect(Object.values(circle(3))[0]).toBe(3); // peguei o valor de radius
    expect(Object.values(circle(3))[1]).toBeCloseTo(28.26); // peguei o valor de area
